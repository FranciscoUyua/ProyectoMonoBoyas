...
private final CentralDatos centralDatos = new CentralDatos();
...
public TelemetriaService(MedicionDAO medicionDAO, AlertaDAO alertaDAO, UsuarioAlertaDAO usuarioAlertaDAO, OperacionDAO operacionDAO) {
